    ...
    function () {
        ...
        Route::middleware(['cors','auth:sanctum'])
            ->group(function () {
                ...
                Route::get('/get-in-out-attendance-data/{timesheet_id}/{startDate}/{endDate}',[TimeSheetController::class, 'getInOutAttendanceData']); 
                ...
                Route::delete('/delete-pending-invite/{id}',[TimeSheetController::class, 'DeletePendingInvite']); 
            });
    }
);
